...
export const StarIcon: React.FC<{ className?: string, solid?: boolean }> = ({ className, solid }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill={solid ? "currentColor" : "none"} viewBox="0 0 24 24" stroke="currentColor" strokeWidth={solid ? 0.5 : 2}>
...
export const UserGroupIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 0 0 3.741-.479 3 3 0 0 0-4.682-2.72m-7.5-2.962A3.75 3.75 0 0 1 15 12a3.75 3.75 0 0 1-2.25 3.512M7.5 12a3.75 3.75 0 0 1 3-3.512A3.75 3.75 0 0 1 15 12m0 0a3.75 3.75 0 0 1-7.5 0M4.5 19.5a3 3 0 0 1 3-3h1.5a3 3 0 0 1 3 3v.5a3 3 0 0 1-3 3h-1.5a3 3 0 0 1-3-3v-.5Z" />
    </svg>
);

export const RocketIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.666 3.888A2.25 2.25 0 0 0 13.5 2.25h-3c-1.03 0-1.9.693-2.166 1.638m7.332 0c.055.194.084.4.084.612v0a2.25 2.25 0 0 1-2.25 2.25H13.5m0-2.25a.75.75 0 0 0-.75-.75H11.25m3.75 0a2.25 2.25 0 0 0-2.25-2.25M11.25 2.25c-.621 0-1.125.504-1.125 1.125v1.5c0 .621.504 1.125 1.125 1.125h1.5c.621 0 1.125-.504 1.125-1.125v-1.5c0-.621-.504-1.125-1.125-1.125m-3.75 11.25c0 .621.504 1.125 1.125 1.125h3.626a1.125 1.125 0 0 1 .97 1.748l-3.468 5.46a.75.75 0 0 1-1.21-.031l-3.468-5.46a1.125 1.125 0 0 1 .97-1.748h3.626Z" />
    </svg>
);
...
export const AnimatedCheckIcon: React.FC<{ className?: string, size?: string }> = ({ className, size = "w-12 h-12" }) => (
    <div className={`${className} ${size} text-green-500`}>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
            <circle cx="12" cy="12" r="10" className="text-green-200 stroke-2" />
            <path d="M8 12l3 3 5-6" className="animate-draw-check text-green-600" />
        </svg>
    </div>
);
...
export const RippleSuccessIcon: React.FC<{ className?: string, size?: string }> = ({ className, size = "w-10 h-10" }) => (
    <div className={`${className} relative flex items-center justify-center ${size}`}>
        ...
        <div className="relative rounded-full bg-sky-500 p-2">
